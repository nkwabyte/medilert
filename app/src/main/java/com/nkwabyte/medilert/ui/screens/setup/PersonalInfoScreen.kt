...
fun PersonalInfoScreen(
    ...
    // Pre-populate fullName from signup data
    ...
    // Update dob when date is selected
    ...
    Box(modifier = Modifier
        ...
        Column(modifier = Modifier
            ...
            Column(
                ...
                Button(
                    onClick = {
                        // Save personal info to SignupViewModel
                        signupViewModel.setPersonalInfo(gender, dob, emergencyContact)
                        // Also update the name in case user changed it
