...
fun SignUpScreen(
    ...
    LaunchedEffect(uiState.isSuccess) {
        if (uiState.isSuccess) {
            ...
            // Navigate to PersonalInfo to collect additional details
            navViewModel.navigateTo(PersonalInfo)
        }
    }

    // Show error message in Snackbar when authentication fails
