    ...
    Box(
        ...
        Box(
            modifier = Modifier
                ...
                .background(
                    Brush.radialGradient(
                        listOf(GhanaYellow.copy(alpha = 0.08f), Color.Transparent)
                    ),
                    CircleShape
                )
        )
        ...
        Column(
            ...
            Box(
                modifier = Modifier
                    .size(200.dp)
                    .background(PrimaryGreen.copy(alpha = 0.08f), RoundedCornerShape(40.dp)),
            ...
            Text(
                text = "Set smart reminders for your medications and get notified at the right time, every time.",
                fontFamily = Poppins,
            ...
            Button(
                onClick = { navViewModel.navigateTo(Onboarding2) },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(60.dp),
