...
fun PersonalInfoScreen(
    ...
    if (selectedDate.isNotEmpty() && selectedDate != dob) dob = selectedDate
    ...
    AuthScreenShell(
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            ...
            OutlinedTextField(
                ...
                colors = OutlinedTextFieldDefaults.colors(
                    ...
                    focusedBorderColor = PrimaryGreen, unfocusedBorderColor = BorderLight,
                    focusedTextColor = TextPrimary, unfocusedTextColor = TextPrimary
                ),
                textStyle = TextStyle(fontFamily = Poppins, fontWeight = FontWeight.Medium, fontSize = 15.sp)
            )
        }
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                listOf("Male", "Female", "Other").forEach { option ->
                    Box(
                        ...
                        Text(option, fontFamily = Poppins, fontWeight = FontWeight.SemiBold,
                            fontSize = 14.sp,
        ...
        Button(
            onClick = {
                ...
                if (fullName != signupData.name) signupViewModel.setBasicInfo(fullName, signupData.email)
